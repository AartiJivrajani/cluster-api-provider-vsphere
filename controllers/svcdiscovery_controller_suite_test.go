...
var _ = BeforeSuite(serviceDiscoveryTestSuite.BeforeSuite)

var _ = AfterSuite(serviceDiscoveryTestSuite.AfterSuite)
...
const (
	...
	supervisorHeadlessSvcFQDN = "supervisor.default.svc"
...
func updateObjectsStatus(ctx context.Context, ctrlClient client.StatusClient, runtimeObjects []client.Object) {
	for _, obj := range runtimeObjects {
